...
class NvidiaProvider(ModelProvider):
    """Nvidia NIM model provider with role compatibility handling
    ...
    def create_model(self, model_id: Optional[str] = None, **kwargs):
        ...
        logger.info(
            f"Creating Nvidia-NIM model: {model_id} (base_url: {self.config.base_url})"
        )
    ...
    def create_embedder(self, model_id: Optional[str] = None, **kwargs):
        ...
        logger.info(f"Creating Sentence Transformers embedder: {model_id}")
